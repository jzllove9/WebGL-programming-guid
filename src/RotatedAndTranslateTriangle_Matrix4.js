...
window.onload = function() {
	...
	/*平移*/
	rotate_translate_matrix(gl, -45, 0.5);
	/*设置颜色*/
	setColor(gl);
...
function rotate_translate_matrix(gl, angle, dis) {
	/*
	...
	*/
	...
	xfromMatrix.translate(dis, 0, 0);*/

	xfromMatrix.setTranslate(dis, 0, 0);
	xfromMatrix.rotate(angle, 0, 0, 1);

	let u_xfromMatrix = gl.getUniformLocation(gl.program, "u_xfromMatrix");
	gl.uniformMatrix4fv(u_xfromMatrix, false, xfromMatrix.elements);
}
